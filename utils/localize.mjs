export const formatDate = (dateString, locale, dateStyle, timeStyle) => {
  ...
  //   dateStyle: 'long', // Uses locale-specific long date format
  //   timeStyle: 'short', // Uses locale-specific short time format
  // }).format(date);

  // return Intl.DateTimeFormat(locale, { dateStyle: format }).format(date);
  // return dayjs(date).locale(locale).format(format)
  // if (locale !== "en") {
  //   return dayjs(date).locale(locale_de).format(format)
  // }
  // else {
