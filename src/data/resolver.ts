...
export async function buildCmsData(
  ...
  for (const locale of localesToProcess) {
    ...
    const localeData: CmsLocaleData = {
      ...
      registerUrl:            features.users ? `/${locale}/${context.config.userPaths[locale].userRegistration}/` : '#',
      registrationSuccessUrl: features.users ? `/${locale}/${context.config.userPaths[locale].userRegistrationSuccess}/` : '#',
      confirmUrl:             features.users ? `/${locale}/${context.config.userPaths[locale].userConfirm}/` : '#',
      confirmSuccessUrl:      features.users ? `/${locale}/${context.config.userPaths[locale].userConfirmSuccess}/` : '#',
      recoverUrl:             features.users ? `/${locale}/${context.config.userPaths[locale].userRecover}/` : '#',
      recoverSuccessUrl:      features.users ? `/${locale}/${context.config.userPaths[locale].userRecoverSuccess}/` : '#',
