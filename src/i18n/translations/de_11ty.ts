export default {
  ...
  checkout: {
    ...
    coupon: {
      ...
      applied: "Eingelöst",
      error: {
        fallback: "Rabattcode konnte nicht eingelöst werden",
        notFound: "Rabattcode nicht gefunden",
        disabled: "Dieser Rabattcode ist nicht mehr aktiv",
        expired: "Dieser Rabattcode ist abgelaufen",
        notYet: "Dieser Rabattcode ist noch nicht gültig",
        exhausted: "Dieser Rabattcode hat sein Einlöselimit erreicht",
        belowMinimum: "Der Warenkorb-Wert liegt unter dem Mindestwert für diesen Code",
      },
    },
  },
  ageGate: {
